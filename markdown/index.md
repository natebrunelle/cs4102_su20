...
1. **Lecture**: will be hosted live online via zoom. Recordings will be posted after (sometimes it takes zoom several hours to process the video). Due to instances of "zoom bombing", you will need a password to join (find it on piazza)
1. **Office Hours**: There will be instructor and TA office hours 5 days a week hosted via zoom (for instructors) and discord (for TAs). These will be open chat rooms for you to discuss with course staff and classmates.
1. **Online submissions**: Problem set solutions must be submitted as a pdf that was generated by LaTeX. 
